...
$this->menu=array(
	...
	array('label'=>Yii::t('app', 'Update') . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->dept_id)),
	array('label'=>Yii::t('app', 'Delete') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->dept_id), 'confirm'=>'Are you sure you want to delete this item?')),
...
<h2><?php echo GxHtml::encode($model->getRelationLabel('baseServiceInfos')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->baseServiceInfos as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('baseServiceInfo/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
