...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'resto_billing_id'); ?>
		<?php echo $form->textField($model, 'resto_billing_id'); ?>
	</div>
...
; ?>
	...
	<div class="row">
		<?php echo $form->label($model, 'transf_to_room'); ?>
		<?php echo $form->checkBox($model, 'transf_to_room', array('maxlength' => 1)); ?>
	</div>
